...
router.post("/api/products/tiles", async (req, res) => {
  try {
...
router.delete("/api/products/tiles/:id", async (req, res) => {
  try {
...
router.put("/api/products/tiles/:id", async (req, res) => {
  try {
...
router.put("/api/products/toilets/:id", async (req, res) => {
  try {
