...
// numeric safe-cast (strips ₹, commas, etc.)
const toNumber = (v) => {
  if (v == null) return 0;
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right text-xs">
                          ...
                          <div>
                            Unit: <span className="font-medium">₹{Number(unitPrice || 0).toFixed(2)}</span>
                          </div>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          ...
                          {it.specs?.totalSqft ? ` • Area: ${it.specs.totalSqft} sqft` : ""}
                        </p>
                      </div>
                      <div className="text-right font-bold text-gray-800">
                        {money(lineTotal)}
                        {/* Removed the "(₹… each)" line as requested */}
                      </div>
                    </div>
                  );
                })}
