...
export default function SalesReports() {
  ...
  const getCategoryData = () => {
    ...
    filteredData.forEach((item) => {
      ...
      categoryMap[item.category] += item.unitsSold;
    });
  ...
  return (
    <div className="flex min-h-screen text-gray-800 bg-gradient-to-br from-slate-100 to-slate-200">
      ...
      <main className="flex-1 px-10 py-8 space-y-10">
        ...
        {loading ? (
          <p className="text-center text-lg font-medium text-gray-600">Loading sales data...</p>
        ) : (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow min-h-[350px]">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={getCategoryData()} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="category" interval={0} angle={-15} textAnchor="end" height={60} />
                    <YAxis />
                    <Tooltip />
                    <Legend />
