...
const bedroomFloorTiles = [
  {
    img: bedroomfloor1,
    name: "White Glossy Tile",
    desc: "Bright and elegant for modern luxury bedrooms.",
  },
  {
    img: bedroomfloor2,
    name: "Charcoal Stone Tile",
    desc: "Bold matte finish, adds strong contrast.",
  },
  {
    img: bedroomfloor3,
    name: "Desert Cream Tile",
    desc: "Subtle marble veins, warm and calming.",
  },
  {
    img: bedroomfloor4,
    name: "City View Tile",
    desc: "Minimal design for high-rise apartments.",
  },
  {
    img: bedroomfloor5,
    name: "Textured Beige Tile",
    desc: "Natural texture perfect for comfort zones.",
  },
];

export default function BedRoomFloorPage() {
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-lg mt-4">
            Perfect flooring to match the comfort of your space
          </p>
        </div>
      </section>
